...
#define TMC524X_GCONF				0x00
#define TMC524X_GSTAT				0x01
...
#define TMC524X_OTW_OV_VTH_ADDR		0x52
...
#define TMC524X_GCONF_FAST_STANDSTILL_SHIFT		1
#define TMC524X_GCONF_EN_PWM_MODE_SHIFT			2
#define TMC524X_GCONF_SHAFT_SHIFT				4
#define TMC524X_GCONF_DIAG0_NINT_STEP_SHIFT		7
#define TMC524X_GCONF_DIAG1_NPOSCOMP_DIR_SHIFT	8
#define TMC524X_GCONF_DIAG0_INT_PUSHPULL_SHIFT	12
#define TMC524X_GCONF_DIAG1_POSCOMP_PUSHPULL_SHIFT	13
#define TMC524X_GCONF_SMALL_HYSTERESIS_SHIFT	14
#define TMC524X_GCONF_STOP_ENABLE_SHIFT			15
#define TMC524X_GCONF_DIRECT_MODE_SHIFT			16
...
#define TMC524X_CHOPCONF_TOFF(n)				(((n) << TMC524X_CHOPCONF_TOFF_SHIFT) & TMC524X_CHOPCONF_TOFF_MASK)
#define TMC524X_CHOPCONF_HSTRT_TFD210_MASK		GENMASK(6, 4)
#define TMC524X_CHOPCONF_HSTRT_TFD210_SHIFT		4
#define TMC524X_CHOPCONF_HSTRT_TFD210(n)		(((n) << TMC524X_CHOPCONF_HSTRT_TFD210_SHIFT) & TMC524X_CHOPCONF_HSTRT_TFD210_MASK)
#define TMC524X_CHOPCONF_HEND_OFFSET_MASK		GENMASK(10, 7)
#define TMC524X_CHOPCONF_HEND_OFFSET_SHIFT		7
#define TMC524X_CHOPCONF_HEND_OFFSET(n)			(((n) << TMC524X_CHOPCONF_HEND_OFFSET_SHIFT) & TMC524X_CHOPCONF_HEND_OFFSET_MASK)
...
#define TMC524X_CHOPCONF_TBL(n)					(((n) << TMC524X_CHOPCONF_TBL_SHIFT) & TMC524X_CHOPCONF_TBL_MASK)
#define TMC524X_CHOPCONF_VHIGHFS				18
#define TMC524X_CHOPCONF_VHIGHCHM				19
#define TMC524X_CHOPCONF_TPFD_MASK				GENMASK(23, 20)
#define TMC524X_CHOPCONF_TPFD_SHIFT				20
#define TMC524X_CHOPCONF_TPFD(n)				(((n) << TMC524X_CHOPCONF_TPFD_SHIFT) & TMC524X_CHOPCONF_TPFD_MASK)
#define TMC524X_CHOPCONF_MRES_MASK				GENMASK(27, 24)
#define TMC524X_CHOPCONF_MRES_SHIFT				24
#define TMC524X_CHOPCONF_MRES(n)				(((n) << TMC524X_CHOPCONF_MRES_SHIFT) & TMC524X_CHOPCONF_MRES_MASK)
#define TMC524X_CHOPCONF_INTPOL					28
...
#define TMC524X_COOLCONF_SEMIN(n)				(((n) << TMC524X_COOLCONF_SEMIN_SHIFT) & TMC524X_COOLCONF_SEMIN_MASK)
#define TMC524X_COOLCONF_SEUP_MASK				GENMASK(6, 5)
#define TMC524X_COOLCONF_SEUP_SHIFT				5
#define TMC524X_COOLCONF_SEUP(n)				(((n) << TMC524X_COOLCONF_SEUP_SHIFT) & TMC524X_COOLCONF_SEUP_MASK)
#define TMC524X_COOLCONF_SEMAX_MASK				GENMASK(11, 8)
#define TMC524X_COOLCONF_SEMAX_SHIFT			8
#define TMC524X_COOLCONF_SEMAX(n)				(((n) << TMC524X_COOLCONF_SEMAX_SHIFT) & TMC524X_COOLCONF_SEMAX_MASK)
#define TMC524X_COOLCONF_SEDN_MASK				GENMASK(14, 13)
#define TMC524X_COOLCONF_SEDN_SHIFT				13
#define TMC524X_COOLCONF_SEDN(n)				(((n) << TMC524X_COOLCONF_SEDN_SHIFT) & TMC524X_COOLCONF_SEDN_MASK)
...
#define TMC524X_DCCTRL_DC_TIME(n)				(((n) << ) & )
...
#define TMC524X_DRV_STATUS_SG_RESULT(n)			(((n) << TMC524X_DRV_STATUS_SG_RESULT_SHIFT) & TMC524X_DRV_STATUS_SG_RESULT_MASK)
...
#define TMC524X_DRV_STATUS_CS_ACTUAL(n)			(((n) << TMC524X_DRV_STATUS_CS_ACTUAL_SHIFT) & TMC524X_DRV_STATUS_CS_ACTUAL_MASK)
#define TMC524X_DRV_STATUS_STATLLGUARD			BIT(24)
...
#define TMC524X_PWMCONFIG_PWM_OFS(n)			(((n) << TMC524X_PWMCONFIG_PWM_OFS_SHIFT) & TMC524X_PWMCONFIG_PWM_OFS_MASK)
#define TMC524X_PWMCONFIG_PWM_GRAD_MASK			GENMASK(15, 8)
#define TMC524X_PWMCONFIG_PWM_GRAD_SHIFT		8
#define TMC524X_PWMCONFIG_PWM_GRAD(n)			(((n) << TMC524X_PWMCONFIG_PWM_GRAD_SHIFT) & TMC524X_PWMCONFIG_PWM_GRAD_MASK)
#define TMC524X_PWMCONFIG_PWM_FREQ_MASK			GENMASK(17, 16)
#define TMC524X_PWMCONFIG_PWM_FREQ_SHIFT		16
#define TMC524X_PWMCONFIG_PWM_FREQ(n)			(((n) << TMC524X_PWMCONFIG_PWM_FREQ_SHIFT) & TMC524X_PWMCONFIG_PWM_FREQ_MASK)
#define TMC524X_PWMCONFIG_FREEWHEEL_MASK		GENMASK(21, 20)
#define TMC524X_PWMCONFIG_FREEWHEEL_SHIFT		20
#define TMC524X_PWMCONFIG_FREEWHEEL(n)			(((n) << TMC524X_PWMCONFIG_FREEWHEEL_SHIFT) & TMC524X_PWMCONFIG_FREEWHEEL_MASK)
#define TMC524X_PWMCONFIG_PWM_REG_MASK			GENMASK(27, 24)
#define TMC524X_PWMCONFIG_PWM_REG_SHIFT			24
#define TMC524X_PWMCONFIG_PWM_REG(n)			(((n) << TMC524X_PWMCONFIG_PWM_REG_SHIFT) & TMC524X_PWMCONFIG_PWM_REG_MASK)
#define TMC524X_PWMCONFIG_PWM_LIM_MASK			GENMASK(31, 28)
