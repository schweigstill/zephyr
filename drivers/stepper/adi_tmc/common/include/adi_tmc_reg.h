...
#define TMC52XX_SWMODE_STOP_L_ENABLE			BIT(0)
#define TMC52XX_SWMODE_STOP_R_ENABLE			BIT(1)
#define TMC52XX_SWMODE_POL_STOP_L				BIT(2)
#define TMC52XX_SWMODE_POL_STOP_R				BIT(3)
#define TMC52XX_SWMODE_SWAP_LR					BIT(4)
#define TMC52XX_SWMODE_LATCH_L_ACTIVE			BIT(5)
#define TMC52XX_SWMODE_LATCH_L_INACTIVE			BIT(6)
#define TMC52XX_SWMODE_LATCH_R_ACTIVE			BIT(7)
#define TMC52XX_SWMODE_LATCH_R_INACTIVE			BIT(8)
#define TMC52XX_SWMODE_EN_LATCH_ENCODER			BIT(9)
#define TMC52XX_SWMODE_SG_STOP					BIT(10)
#define TMC52XX_SWMODE_EN_SOFTSTOP				BIT(11)
#define TMC52XX_SWMODE_EN_VIRTUAL_STOP_L		BIT(12)
#define TMC52XX_SWMODE_EN_VIRTUAL_STOP_R		BIT(13)
#define TMC52XX_SWMODE_VIRTUAL_STOP_ENC			BIT(14)

/* === RAMPSTAT bit positions (TMC5240) === */

#define TMC52XX_RAMPSTAT_STATUS_STOP_L			BIT(0)
#define TMC52XX_RAMPSTAT_STATUS_STOP_R			BIT(1)
#define TMC52XX_RAMPSTAT_STATUS_LATCH_L			BIT(2)
#define TMC52XX_RAMPSTAT_STATUS_LATCH_R			BIT(3)
#define TMC52XX_RAMPSTAT_EVENT_STOP_L			BIT(4)
#define TMC52XX_RAMPSTAT_EVENT_STOP_R			BIT(5)
#define TMC52XX_RAMPSTAT_EVENT_STOP_SG			BIT(6)
#define TMC52XX_RAMPSTAT_EVENT_POS_REACHED		BIT(7)
#define TMC52XX_RAMPSTAT_VELOCITY_REACHED		BIT(8)
#define TMC52XX_RAMPSTAT_POSITION_REACHED		BIT(9)
#define TMC52XX_RAMPSTAT_VZERO					BIT(10)
#define TMC52XX_RAMPSTAT_T_ZEROWAIT_ACTIVE		BIT(11)
#define TMC52XX_RAMPSTAT_SECOND_MOVE			BIT(12)
#define TMC52XX_RAMPSTAT_STATUS_SG				BIT(13)
#define TMC52XX_RAMPSTAT_STATUS_VIRTUAL_STOP_L	BIT(14)
#define TMC52XX_RAMPSTAT_STATUS_VIRTUAL_STOP_R	BIT(15)

/* === ENCMODE bit positions (TMC5240) === */

#define TMC52XX_ENCMODE_POL_A                   BIT(0)
#define TMC52XX_ENCMODE_POL_B                   BIT(1)
#define TMC52XX_ENCMODE_POL_N                   BIT(2)
#define TMC52XX_ENCMODE_IGNORE_AB               BIT(3)
#define TMC52XX_ENCMODE_CLR_CONT                BIT(4)
#define TMC52XX_ENCMODE_CLR_ONCE                BIT(5)
#define TMC52XX_ENCMODE_POS_NEG_EDGE_MASK  		GENMASK(7, 6)
#define TMC52XX_ENCMODE_POS_NEG_EDGE_SHIFT 		6
#define TMC52XX_ENCMODE_POS_NEG_EDGE(n)    		(((n) << TMC52XX_ENCMODE_POS_NEG_EDGE_SHIFT) & TMC52XX_ENCMODE_POS_NEG_EDGE_MASK)
#define TMC52XX_ENCMODE_CLR_ENC_X               BIT(8)
#define TMC52XX_ENCMODE_LATCH_X_ACT             BIT(9)
#define TMC52XX_ENCMODE_ENC_SEL_DECIMAL         BIT(10)

/* === ENCMODE bit positions (TMC5240) === */

#define TMC52XX_ENCSTATUS_N_EVENT				BIT(0)
#define TMC52XX_ENCSTATUS_DEVIATION_WARN		BIT(1)

/* === ADC_VSUPPLY_AIN bit positions (TMC5240) === */

#define TMC52XX_ADC_VSUPPLY_MASK				GENMASK(12, 0)
#define TMC52XX_ADC_VSUPPLY_SHIFT				0
#define TMC52XX_ADC_VSUPPLY(n)					(((n) << TMC52XX_ADC_VSUPPLY_SHIFT) & TMC52XX_ADC_VSUPPLY_MASK)
#define TMC52XX_ADC_VIN_MASK					GENMASK(28, 16)
#define TMC52XX_ADC_VIN_SHIFT					16
#define TMC52XX_ADC_VIN(n)						(((n) << TMC52XX_ADC_VIN_SHIFT) & TMC52XX_ADC_VIN_MASK)
                       
/* === OTW_OV_VTH bit positions (TMC5240) === */

#define TMC52XX_OTW_OV_VTH_MASK					GENMASK(12, 0)
#define TMC52XX_OTW_OV_VTH_SHIFT                0
#define TMC52XX_OTW_OV_VTH(n)                   (((n) << TMC52XX_OTW_OV_VTH_SHIFT) & TMC52XX_OTW_OV_VTH_MASK)
#define TMC52XX_OVERTEMMPPREWARNING_VTH_MASK    GENMASK(28, 16)
#define TMC52XX_OVERTEMMPPREWARNING_VTH_SHIFT   16
#define TMC52XX_OVERTEMMPPREWARNING_VTH(n)      (((n) << TMC52XX_OVERTEMMPPREWARNING_VTH_SHIFT) & TMC52XX_OVERTEMMPPREWARNING_VTH_MASK)

/* === TMC52XX_MSLUTSEL bit positions (TMC5240) === */

#define TMC52XX_MSLUTSEL_W0_MASK 				GENMASK(1, 0)
#define TMC52XX_MSLUTSEL_W0_SHIFT				0
#define TMC52XX_MSLUTSEL_W0(n)					(((n) << TMC52XX_MSLUTSEL_W0_SHIFT) & TMC52XX_MSLUTSEL_W0_MASK)
#define TMC52XX_MSLUTSEL_W1_MASK 				GENMASK(3, 2)
#define TMC52XX_MSLUTSEL_W1_SHIFT   			2
#define TMC52XX_MSLUTSEL_W1(n)					(((n) << TMC52XX_MSLUTSEL_W1_SHIFT) & TMC52XX_MSLUTSEL_W1_MASK)
#define TMC52XX_MSLUTSEL_W2_MASK 				GENMASK(5, 4)
#define TMC52XX_MSLUTSEL_W2_SHIFT   			4
#define TMC52XX_MSLUTSEL_W2(n)					(((n) << TMC52XX_MSLUTSEL_W2_SHIFT) & TMC52XX_MSLUTSEL_W2_MASK)
#define TMC52XX_MSLUTSEL_W3_MASK 				GENMASK(7, 6)
#define TMC52XX_MSLUTSEL_W3_SHIFT   			6
#define TMC52XX_MSLUTSEL_W3(n)					(((n) << TMC52XX_MSLUTSEL_W3_SHIFT) & TMC52XX_MSLUTSEL_W3_MASK)
#define TMC52XX_MSLUTSEL_X1_MASK 				GENMASK(15, 8)
#define TMC52XX_MSLUTSEL_X1_SHIFT   			8
#define TMC52XX_MSLUTSEL_X1(n)					(((n) << TMC52XX_MSLUTSEL_X1_SHIFT) & TMC52XX_MSLUTSEL_X1_MASK)
#define TMC52XX_MSLUTSEL_X2_MASK 				GENMASK(23, 16)
#define TMC52XX_MSLUTSEL_X2_SHIFT   			16
#define TMC52XX_MSLUTSEL_X2(n)					(((n) << TMC52XX_MSLUTSEL_X2_SHIFT) & TMC52XX_MSLUTSEL_X2_MASK)
#define TMC52XX_MSLUTSEL_X3_MASK 				GENMASK(31, 24)
#define TMC52XX_MSLUTSEL_X3_SHIFT   			24
#define TMC52XX_MSLUTSEL_X3(n)					(((n) << TMC52XX_MSLUTSEL_X3_SHIFT) & TMC52XX_MSLUTSEL_X3_MASK)

/* === TMC52XX_MSLUTSTART bit positions (TMC5240) === */

#define TMC52XX_MSLUTSTART_START_SIN_MASK		GENMASK(7, 0)
#define TMC52XX_MSLUTSTART_START_SIN_SHIFT		0
#define TMC52XX_MSLUTSTART_START_SIN(n)			(((n) << TMC52XX_MSLUTSTART_START_SIN_SHIFT) & TMC52XX_MSLUTSTART_START_SIN_MASK)
#define TMC52XX_MSLUTSTART_START_SIN90_MASK		GENMASK(23, 16)
#define TMC52XX_MSLUTSTART_START_SIN90_SHIFT	16
#define TMC52XX_MSLUTSTART_START_SIN90(n)		(((n) << TMC52XX_MSLUTSTART_START_SIN90_SHIFT) & TMC52XX_MSLUTSTART_START_SIN90_MASK)
#define TMC52XX_MSLUTSTART_OFFSET_SIN90_MASK	GENMASK(31, 24)
#define TMC52XX_MSLUTSTART_OFFSET_SIN90_SHIFT	24
#define TMC52XX_MSLUTSTART_OFFSET_SIN90(n)		(((n) << TMC52XX_MSLUTSTART_OFFSET_SIN90_SHIFT) & TMC52XX_MSLUTSTART_OFFSET_SIN90_MASK)


#define TMC52XX_MSCURACT_CUR_B_MASK 			GENMASK(8, 0)
#define TMC52XX_MSCURACT_CUR_B_SHIFT			0
#define TMC52XX_MSCURACT_CUR_B(n)				(((n) << TMC52XX_MSCURACT_CUR_B_SHIFT) & TMC52XX_MSCURACT_CUR_B_MASK)
#define TMC52XX_MSCURACT_CUR_A_MASK				GENMASK(24, 16)
#define TMC52XX_MSCURACT_CUR_A_SHIFT			16
#define TMC52XX_MSCURACT_CUR_A(n)				(((n) << TMC52XX_MSCURACT_CUR_A_SHIFT) & TMC52XX_MSCURACT_CUR_A_MASK)


                       
#if 0
#define TMC52XX__MASK GENMASK(3, 0)
#define TMC52XX__SHIFT      24
#define TMC52XX_(n)    		(((n) << ) & )
#endif
